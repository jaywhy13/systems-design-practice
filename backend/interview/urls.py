...
urlpatterns = [
    ...
    path('<uuid:interview_id>/articles/<uuid:article_id>/chat/', views.start_article_chat, name='start_article_chat'),
    path('article-chat/<uuid:chat_id>/', views.get_article_chat, name='get_article_chat'),
    path('article-chat/<uuid:chat_id>/send/', views.send_article_message, name='send_article_message'),
]
